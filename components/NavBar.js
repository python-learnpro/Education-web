  ...
  return (
    <div className='mx-auto '>
        <div className="container flex flex-col lg:flex-row py-2 justify-between items-center">
            ...
            <div className="flex gap-2 items-center border border-[#] px-0.5 pl-2 py-0.5 rounded-md" >
                <CiSearch className='text-[#E7BCDE]'/>
                <input className='focus:outline-none' type="text" placeholder='Want to learn?'/>
                <button className='flex items-center px-3 py-1 font-medium text-purple-400 capitalize rounded-md bg-purple-50 hover:bg-purple-200'>Explore
                    <BsArrowDownShort/>
                </button>
            </div>
            ...
            <div className="flex items-center gap-4">
                ...
                <p className='text-base font-medium capitalize bg-purple-400 border border-none cursor-pointer btn btn-sm'>Create Free Account</p>
