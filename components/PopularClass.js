...
const PopularClass = () => {
  ...
  return (
    <div className="container mx-auto md:h-screen py-10">
      <p className="text-lg text-purple-400  font-medium">Explore Programs</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-12 py-10">
        {service.map((ser, i) => {
          return (
            <div
              className="px-6 py-4  rounded-xl bg-gray-50 shadow-lg border border-gray-200 hover:bg-purple-400 group "
              key={i}
            >
